...
//import * as moment from '../../../assets/js/moment-timezone-with-data.js';
//const moment = moment;
...
@Component({
	...
	templateUrl: './app-daterangepicker.component.html',
	styleUrls: ['./app-daterangepicker.component.scss'],
	host: {
...
export class AppDaterangepickerComponent implements OnInit {
    ...
    renderRanges() {
        ...
        if (typeof this.ranges === 'object') {
			...
			//console.log("Show Custom Range Lable:");
			//console.log(this.showCustomRangeLabel);
			
            if (this.showCustomRangeLabel) {
				//console.log("Custom Range Label added:");
