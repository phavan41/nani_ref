...
export class HeaderComponent implements OnInit {
  ...
  notificationRefreshTimer:any;
    ...
    constructor(private apphelper:AppHelper,private _service:CommonService,
        private _languageservice:LanguageService, private _notificationService:NotificationService,
        private _timesoneservice: TimeZoneService,
        private route: ActivatedRoute,
        private _profileaction:ProfileActionService,private router:Router,public globals: Globals,
		private helper: Helper,private modalService: NgbModal) { 
